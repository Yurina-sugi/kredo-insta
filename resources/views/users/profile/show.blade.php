...
@section('content')
    ...
    <div style="margin-top: 40px">
        ...
        {{-- Display only if AI information exists --}}
        @if (isset($personalitySummary))
            <div class="ai-summary-box">
                <h5>🧠 Personality Insight Generated by AI</h5>
                <p>
        ...
        @if (isset($recommendedTourLink))
            <div class="ai-tour-box">
                <strong>✨ Your Personalized Tour Suggestion →
                ...
                <p style="font-size: 0.95rem; color: #333; margin-top: 10px;">
                    🧭 Based on your interests and recent comments, AI predicts this tour may involve scenic exploration,
